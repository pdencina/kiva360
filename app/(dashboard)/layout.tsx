      ...
      <aside style={{
        ...
        <div style={{
          ...
          <div style={{ minWidth: 0 }}>
            <div style={{ color: '#E3F2FD', fontSize: '0.78rem', fontWeight: '600', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              {user.email}
            </div>
        ...
        {/* Footer integraciones */}
        <div style={{
          padding: '0.8rem 1rem',
          borderTop: '1px solid rgba(255,255,255,0.07)'
        }}>
          <div style={{ fontSize: '0.58rem', color: '#1E3A5F', fontWeight: '700', marginBottom: '0.4rem', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
